import { createRenderer } from 'file://C:/Users/Dell%20Tim/documents/github/lumory/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { eventHandler, getQuery, appendHeader } from 'file://C:/Users/Dell%20Tim/documents/github/lumory/node_modules/h3/dist/index.mjs';
import { joinURL } from 'file://C:/Users/Dell%20Tim/documents/github/lumory/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file://C:/Users/Dell%20Tim/documents/github/lumory/node_modules/vue/server-renderer/index.mjs';
...
const getSSRStyles = () => import('./styles.mjs').then(function (n) { return n.s; }).then((r) => r.default || r);
...
const renderer = defineRenderHandler(async (event) => {
  ...
  const ssrContext = {
    ...
    noSSR: !!event.req.headers["x-nuxt-no-ssr"] || (PRERENDER_NO_SSR_ROUTES.has(url) ),
    error: !!ssrError,
    nuxt: void 0,
