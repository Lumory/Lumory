import { computed, defineComponent, getCurrentInstance, ref, h, resolveComponent, watchEffect, markRaw, reactive, useSSRContext, createApp, toRef, isRef, shallowRef, defineAsyncComponent, provide, onErrorCaptured, unref, mergeProps, inject } from 'file://C:/Users/Dell%20Tim/documents/github/lumory/node_modules/vue/index.mjs';
import { $fetch } from 'file://C:/Users/Dell%20Tim/documents/github/lumory/node_modules/ohmyfetch/dist/node.mjs';
import { joinURL, hasProtocol, isEqual, parseURL, stringifyParsedURL, stringifyQuery, parseQuery } from 'file://C:/Users/Dell%20Tim/documents/github/lumory/node_modules/ufo/dist/index.mjs';
import { createHooks } from 'file://C:/Users/Dell%20Tim/documents/github/lumory/node_modules/hookable/dist/index.mjs';
import { getContext } from 'file://C:/Users/Dell%20Tim/documents/github/lumory/node_modules/unctx/dist/index.mjs';
import { createError as createError$1, sendRedirect } from 'file://C:/Users/Dell%20Tim/documents/github/lumory/node_modules/h3/dist/index.mjs';
import defu, { defuFn } from 'file://C:/Users/Dell%20Tim/documents/github/lumory/node_modules/defu/dist/defu.mjs';
import { isFunction } from 'file://C:/Users/Dell%20Tim/documents/github/lumory/node_modules/@vue/shared/index.js';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderAttrs, ssrRenderAttr, ssrInterpolate } from 'file://C:/Users/Dell%20Tim/documents/github/lumory/node_modules/vue/server-renderer/index.mjs';
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import('./error-component.c4e845f1.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
const AppComponent = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-25102a06"]]);
if (!globalThis.$fetch) {
