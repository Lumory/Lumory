    ...
    <n-form ref="formRef" :model="formValue" size="large" :rules="rules">
      <n-grid cols="12" :x-gap="24" item-responsive responsive="screen">
        ...
        <n-form-item-gi class="form-item--left-align" :span="12" path="password" label="Wachtwoord">
          <n-input v-model:value="formValue.password" placeholder="Wachtwoord" @keydown.enter.prevent type="password" show-password-on="mousedown"/>
        </n-form-item-gi>
        <n-form-item-gi class="form-item--left-align" :span="12" path="repeatPassword" label="Herhaal wachtwoord">
          <n-input v-model:value="formValue.repeatPassword" placeholder="Herhaal wachtwoord" @keydown.enter.prevent on-change="" type="password" show-password-on="mousedown"/>
        </n-form-item-gi>
      </n-grid>
    </n-form>
  </n-space>
